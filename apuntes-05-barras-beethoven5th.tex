\section{``La llamada del destino'' (\emph{Quinta sinfonía} de Beethoven)}


\subsection{Modelo}

En este modelo que reproduce el tema del primer movimiento de la
\emph{Quinta sinfonía} de Beethoven, vemos un caso de barrado manual:
...
forma \verb+\version "2.15.30"+, donde aparece entrecomillado el
...
\begin{verbatim}GNU LilyPond 2.15.30
