\section{Ornamentos barrocos: \emph{Aria} de las \emph{Variaciones Goldberg}.}


\subsection{Modelo}

El siguiente fragmento es el comienzo del \emph{Aria} de las
\emph{Variaciones Goldberg BWV 988} de Bach.  Contiene abundantes
apoyaturas y ornamentos barrocos, y nos servirá para introducir las
notas de adorno en general.
