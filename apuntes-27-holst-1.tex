...
partiturita=\markup{
  \score {
    ...
    \layout{
      \context {
        \RhythmicStaff \remove "Time_signature_engraver"
      }
    }
  }
}
...
Además no tiene indicación de compás, para ello hay que eliminar el
grabador correspondiente del contexto de Staff: véase el apartado
\ref{consists} de la página \pageref{consists}.
