...
Si no nos preocupa la producción de MIDI, para producir una particella
con destino a un instrumento transpositor a partir de música en tono
de concierto, sólo hay que aplicar el transporte inverso en el momento
de imprimir la particella.
