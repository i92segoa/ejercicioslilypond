\documentclass[10pt,a4paper,oneside,headinclude,titlepage]{scrartcl} % la clase book del Koma-script bundle
%\documentclass[10pt,a4paper,oneside,headinclude,titlepage]{scrbook} % la clase book del Koma-script bundle
...
%\usepackage[utopia]{mathdesign} %nof
%\usepackage{xltxtra}
...
%  \setmainfont[Scale=0.925]{ResagokrBold} %funciona!
%  \setmainfont[Scale=0.925]{CenturySchL-Roma} %funciona!
\setmainfont{Heuristica} % UTOPIA: funciona!
%  \setmainfont{TeX Gyre Pagella} %Funciona
