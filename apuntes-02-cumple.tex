...
\begin[fragment,notime,staffsize=13]{lilypond}
{ c' d' e' f' g' a' b' }
\end{lilypond}

Añadiremos otro apóstrofo para nombrar las notas de la octava
superior:
...
Las notas sin apóstrofo dan la octava inferior al Do central.
...
Al añadir una coma obtenemos la octava inferior:
...
y otra octava por debajo si añadimos otra coma:

\verb+c,, d,, e,, f,, g,, a,, b,,+

\begin[fragment,notime,staffsize=13]{lilypond}
{ \clef bass \ottava #-1 c,, d,, e,, f,, g,, a,, b,, }
\end{lilypond}
...
\begin[verbatim,notime,staffsize=13]{lilypond}
\relative c' { c e g c g' a f e d c g c, c' c, }
\end{lilypond}
